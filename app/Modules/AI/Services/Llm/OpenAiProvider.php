...
class OpenAiProvider implements LlmProviderInterface
{
    ...
    public function __construct(
        ...
        private readonly string $chatModel = 'openrouter/auto',
    ...
    public function chat(array $messages, array $opts = []): LlmResponse
    {
        ...
        if (! $resp->successful()) {
            throw new \RuntimeException('OpenRouter chat failed: '.$resp->body());
        }
    ...
    public function embed(array $texts): array
    {
        ...
        if (! $resp->successful()) {
            throw new \RuntimeException('OpenRouter embed failed: '.$resp->body());
        }
